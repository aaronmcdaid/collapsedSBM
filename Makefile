...
${MAIN}: gitstatus.o shmGraphRaw.o Range.o aaron_utils.o sbm_state.o cmdline.o scf.o graph/weights.o graph/strings.o graph/loading.o graph/network.o graph/saving.o
